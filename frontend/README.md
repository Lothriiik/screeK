...
Este diretório encapsula a interface do usuário (SPA) do screeK. Construído para ser uma vitrine de imersão de usuário e UX veloz, o frontend abandona as interfaces genéricas e abraça uma estética ousada.

## 📐 Design System & Estética

> 🖌️ **Mockups e Protótipos:** [Visualizar o board do Figma - screeK Design Project](https://www.figma.com/design/YU8WBTTEUgTk70VLmZAtBo/Design-Project---screek?node-id=0-1&t=Ok9SFoy1isIhGm2T-1)

---

## 🔌 Consumo de Dados (A Arquitetura Híbrida)

O Frontend do screeK é inteligente ao falar com a API: ele atua utilizando dois paradigmas simultâneos.
...
---
*Este módulo é integrante do projeto de comprovação arquitetural screeK.*
